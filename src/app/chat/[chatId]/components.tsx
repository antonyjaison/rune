...
export const IndividualChatPage = ({ chatDetails } : IndividualChatPageProps) => {
    const { messages, input, handleInputChange, handleSubmit, setMessages } = useChat({
        initialMessages: chatDetails.data?.messages as any
    });
    // console.log(chatDetails.data?.messages)
